...
<div className="Article">
    ...
    <p>
        ...
        <strong>Tip: The grammatical gender doesn’t follow a logical set of rules. So, always learn German nouns and
            articles together.</strong>
    </p>

    <iframe className="youtube-video" width="560" height="315" src="https://www.youtube.com/embed/x-NiFYOgPwQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
